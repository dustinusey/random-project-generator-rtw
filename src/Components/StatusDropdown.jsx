...
export default function StatusDropdown(props) {
    return (
        <div className="status-dropdown max-w-fit">
            <button id="dropdownDefaultButton" data-dropdown-toggle={`dropdown_${props.projectName}`} className="text-white bg-gray-600 hover:bg-gray-700 duration-300 focus:ring-4 focus:outline-none focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-gray-700 dark:hover:bg-gray-600  dark:focus:ring-gray-500" type="button">
            ...
            <div id={`dropdown_${props.projectName}`} className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-950">
