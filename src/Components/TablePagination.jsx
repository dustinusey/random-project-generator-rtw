export default function TablePagination() {
    return (
            <nav className="p-10 flex justify-center" aria-label="Table page navigation">
                <ul className="inline-flex -space-x-px text-sm">
                    ...
                    <li>
                        <a href="#" aria-current="page" className="flex items-center justify-center px-3 h-8 text-teal-600 border border-gray-300 bg-blue-50 hover:bg-blue-100 hover:text-teal-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white">1</a>
                    </li>
                    <li>
